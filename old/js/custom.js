...
(function() {
    ...
    // ul to select
    var optionsList = '<option value="" selected>Selecione...</option>';
...
var infowindow = new google.maps.InfoWindow({ content: "carregando..." });
    ...
    if($('#home').length){
        $.supersized({
                    ...
                    slides                  :   [           // Slideshow Images
                                        {image : './images/slider/super/supersized-1.jpg', title : 'PISO DE PORCELANATO LÍQUIDO', thumb : '', url : ''},
                                        {image : './images/slider/super/supersized-2.jpg', title : '', thumb : '', url : ''},					 
					                    {image : './images/slider/super/supersized-3.jpg', title : '', thumb : '', url : ''},
										{image : './images/slider/super/supersized-4.jpg', title : '', thumb : '', url : ''},
                                        {image : './images/slider/super/supersized-5.jpg', title : '', thumb : '', url : ''},
