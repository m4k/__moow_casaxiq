        ...
        $.fn.jCarouselLite=function(o){
            o=$.extend({
                ...
                return this.each(function(){
                    var b=false,
                    animCss=o.vertical?"top":"left",sizeCss=o.vertical?"height":"width";
                    ...
                    var h=g*itemLength;
                    var j=g*v;f.css({width:f.width(),height:f.height()});ul.css(sizeCss,h+"px").css(animCss,-(curr*g));
                    c.css(sizeCss,j+"px");
                    ...
                    if(o.auto)setInterval(function(){
                        ...
                        function go(a){
                            ...
                            if(o.circular){
                                ...
                                else curr=a}b=true;ul.animate(animCss=="left"?{left:-(curr*g)}:{top:-(curr*g)
